...
public class LivroTestSamples {
    ...
    public static Livro getLivroSample1() {
        return new Livro().id(1L).titulo("titulo1").autor("autor1").anoPublicacao(1).isbn("isbn1");
    }

    public static Livro getLivroSample2() {
        return new Livro().id(2L).titulo("titulo2").autor("autor2").anoPublicacao(2).isbn("isbn2");
    }
    ...
    public static Livro getLivroRandomSampleGenerator() {
        return new Livro()
            ...
            .anoPublicacao(intCount.incrementAndGet())
