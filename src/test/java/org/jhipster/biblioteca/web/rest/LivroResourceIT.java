...
import static org.jhipster.biblioteca.domain.LivroAsserts.*;
...
class LivroResourceIT {
    ...
    private static final Integer DEFAULT_ANO_PUBLICACAO = 1;
    private static final Integer UPDATED_ANO_PUBLICACAO = 2;
    ...
    public static Livro createEntity() {
        return new Livro().titulo(DEFAULT_TITULO).autor(DEFAULT_AUTOR).anoPublicacao(DEFAULT_ANO_PUBLICACAO).isbn(DEFAULT_ISBN);
    }
    ...
    public static Livro createUpdatedEntity() {
        return new Livro().titulo(UPDATED_TITULO).autor(UPDATED_AUTOR).anoPublicacao(UPDATED_ANO_PUBLICACAO).isbn(UPDATED_ISBN);
    }
    ...
    @Test
    @Transactional
    void checkAnoPublicacaoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
    ...
    void getAllLivros() throws Exception {
        ...
        restLivroMockMvc
            ...
            .andExpect(jsonPath("$.[*].anoPublicacao").value(hasItem(DEFAULT_ANO_PUBLICACAO)))
    ...
    void getLivro() throws Exception {
        ...
        restLivroMockMvc
            ...
            .andExpect(jsonPath("$.anoPublicacao").value(DEFAULT_ANO_PUBLICACAO))
    ...
    void putExistingLivro() throws Exception {
        ...
        updatedLivro.titulo(UPDATED_TITULO).autor(UPDATED_AUTOR).anoPublicacao(UPDATED_ANO_PUBLICACAO).isbn(UPDATED_ISBN);
    ...
    void partialUpdateLivroWithPatch() throws Exception {
        ...
        partialUpdatedLivro.titulo(UPDATED_TITULO).autor(UPDATED_AUTOR).anoPublicacao(UPDATED_ANO_PUBLICACAO).isbn(UPDATED_ISBN);
