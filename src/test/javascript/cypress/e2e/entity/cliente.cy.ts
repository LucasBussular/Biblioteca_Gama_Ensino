...
describe('Cliente e2e test', () => {
  ...
  const clienteSample = { nome: 'extricate in', email: 'Livia90@live.com' };
  ...
  describe('new Cliente page', () => {
    ...
    it('should create an instance of Cliente', () => {
      cy.get(`[data-cy="nome"]`).type('until');
      cy.get(`[data-cy="nome"]`).should('have.value', 'until');

      cy.get(`[data-cy="email"]`).type('MariaEduarda81@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'MariaEduarda81@gmail.com');

      cy.get(`[data-cy="telefone"]`).type('nun alongside');
      cy.get(`[data-cy="telefone"]`).should('have.value', 'nun alongside');
