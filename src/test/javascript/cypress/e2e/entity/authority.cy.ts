...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '52b6c36c-8873-41cc-9745-52e1a27698ee' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5c216ab5-e9c1-4a06-a497-11f99a1e4006');
      cy.get(`[data-cy="name"]`).should('have.value', '5c216ab5-e9c1-4a06-a497-11f99a1e4006');
